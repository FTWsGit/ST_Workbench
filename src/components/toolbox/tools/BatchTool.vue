<template>
  <div class="wb-tools-body">
    <p v-if="isNoBatchScene" class="wb-muted">
      {{ uiStore.t('toolbox.batch.noBatchTools') }}
    </p>

    <template v-else>
      <p class="wb-muted">
        {{ uiStore.t('toolbox.batch.selectedCount', { count: selectedCount }) }}
      </p>
      ...
      <div v-if="isRegex" class="wb-tools-section">
        <FormField :label="uiStore.t('toolbox.batch.enableLabel')">
          <div class="wb-btn-surface">
            ...
            <button class="wb-btn sm" :disabled="!selectedCount" @click="regexSetDisabled(true)">
              {{ uiStore.t('toolbox.batch.disableSelected') }}
            </button>
          </div>
        </FormField>
      </div>
      ...
      <div v-else-if="isPresetItems" class="wb-tools-section">
        <FormField :label="uiStore.t('toolbox.batch.enableLabel')">
          <div class="wb-btn-surface">
            ...
            <button class="wb-btn sm" :disabled="!selectedCount" @click="presetSetEnabled(false)">
              {{ uiStore.t('toolbox.batch.disableSelected') }}
            </button>
          </div>
        </FormField>
      ...
      <div v-else-if="isWorldbookItems" class="wb-tools-section">
        <FormField :label="uiStore.t('toolbox.batch.enableLabel')">
          <div class="wb-btn-surface">
            ...
            <button class="wb-btn sm" :disabled="!selectedCount" @click="wbSetDisabled(true)">
              {{ uiStore.t('toolbox.batch.disableSelected') }}
            </button>
          </div>
        </FormField>
        <FormField :label="uiStore.t('toolbox.batch.activationLabel')">
          <div class="wb-btn-surface">
            ...
            <button
              class="wb-btn sm"
              :disabled="!selectedCount"
              @click="wbSetActivation('constant')"
            >
            ...
            <button
              class="wb-btn sm"
              :disabled="!selectedCount"
              @click="wbSetActivation('vectorized')"
            >
      ...
      <p v-if="!selectedCount" class="wb-muted">
        {{ uiStore.t('toolbox.batch.noSelection') }}
      </p>
    </template>
  </div>
</template>
