    ...
    <div class="wb-rp-header">
      ...
      <div class="wb-row-tight">
        <button
          ...
          :class="{ active: uiStore.settings.settingsDockFloat }"
...
const FORMS: Record<string, Component> = {
  regex: RegexSettingsForm,
  preset: PresetSettingsForm,
  worldbook: WorldbookSettingsForm,
  tavern: TavernSettingsForm,
};
