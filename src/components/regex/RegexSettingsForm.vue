<template>
  <div v-if="script" class="wb-form">
    ...
    <FormField :label="props.t('regex.settings.findRegexLabel')">
      <textarea class="wb-form-textarea" :class="{ invalid: !findValid }" rows="2" v-model="script.findRegex" :placeholder="props.t('regex.settings.findRegexPlaceholder')"></textarea>
      <p v-if="!findValid" class="wb-regex-err">{{ props.t('regex.settings.findRegexInvalid') }}</p>
    </FormField>

    <FormField :label="props.t('regex.settings.scriptNameLabel')">
      <input class="wb-form-input" v-model="script.scriptName" :placeholder="props.t('regex.settings.scriptNamePlaceholder')" />
    </FormField>
    ...
    <AdvancedGroup :title="props.t('regex.settings.advancedToggle')">
      ...
      <label class="wb-form-check"><input type="checkbox" v-model="script.runOnEdit" /> {{ props.t('regex.settings.runOnEdit') }}</label>
