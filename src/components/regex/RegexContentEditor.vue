<template>
  <div class="wb-editor-panel wb-regex-editor" v-if="script">
    <div class="wb-editor-meta">
      ...
      <template v-if="mode === 'preview'">
        <button class="wb-btn sm" :class="{ active: !renderHtml }" @click="renderHtml = false">
          {{ props.t('regex.editor.plainText') }}
        </button>
        <button class="wb-btn sm" :class="{ active: renderHtml }" @click="renderHtml = true">
          {{ props.t('regex.editor.html') }}
        </button>
      </template>
      <button
        class="wb-btn sm"
    ...
    <div v-else class="wb-regex-editor-body">
      <div v-if="!renderHtml" class="wb-regex-editor-preview">
        {{ previewText }}
      </div>
