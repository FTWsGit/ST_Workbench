...
export const useWorldbookStore = defineStore('worldbook', () => {
  ...
  function refreshWorldbookList() {
    WB.listWorldbooks()
      ...
      .catch((e: unknown) =>
        showToast(t('worldbook.toast.listFailed', { msg: e instanceof Error ? e.message : String(e) }))
      )
  }
  ...
  async function loadWorldbookByName(name: string, opts: { silent?: boolean } = {}) {
    ...
    try {
      ...
      showToast(t('worldbook.toast.loadFailed', { msg: e instanceof Error ? e.message : String(e) }))
      return
    }
    if (!data) {
  ...
  async function doSaveWorldbook() {
    ...
    try {
      ...
      showToast(t('worldbook.toast.saveFailed', { msg: e instanceof Error ? e.message : String(e) }))
    }
  }
  ...
  async function createNewWorldbook(name: string) {
    ...
    try {
      ...
      showToast(t('worldbook.toast.createFailed', { msg: e instanceof Error ? e.message : String(e) }))
    }
  }
  ...
  async function importFromCharacterBook(
    ...
    try {
      ...
      showToast(t('worldbook.toast.importFailed', { msg: e instanceof Error ? e.message : String(e) }))
    }
  }
  ...
  async function removeCurrentWorldbook() {
    ...
    try {
      ...
      showToast(t('worldbook.toast.deleteFailed', { msg: e instanceof Error ? e.message : String(e) }))
    }
  }
