...
export const useCharacterStore = defineStore('character', () => {
  ...
  function refreshCharacterList() {
    CH.listCharacters()
      ...
      .catch((e: unknown) =>
        showToast(t('character.toast.listFailed', { msg: e instanceof Error ? e.message : String(e) }))
      )
  }
  ...
  async function loadCharacterByAvatar(avatar: string, opts: { silent?: boolean } = {}) {
    ...
    try {
      ...
      showToast(t('character.toast.loadFailed', { msg: e instanceof Error ? e.message : String(e) }))
      return
    }
    if (!result) {
  ...
  async function createNewCharacter(name: string) {
    ...
    try {
      ...
      showToast(t('character.toast.createFailed', { msg: e instanceof Error ? e.message : String(e) }))
    }
  }
  ...
  async function removeCurrentCharacter() {
    ...
    try {
      ...
      showToast(t('character.toast.deleteFailed', { msg: e instanceof Error ? e.message : String(e) }))
    }
  }
  ...
  async function doSaveCharacter() {
    ...
    try {
      ...
      showToast(t('character.toast.saveFailed', { msg: e instanceof Error ? e.message : String(e) }))
    }
  }
